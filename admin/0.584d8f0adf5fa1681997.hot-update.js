        ...
        if (state && state.scrollTo && _this.scrollbar) {
          ...
          setTimeout(function () {
            ...
            if (_this.lefsideSection) {
              ...
              if (direction < 0) {
                offsetTop = _top - 80 - margin * 1.5;
              } else {
                offsetTop = vh / 2 + height / 2 - margin * 1.5;
              }
            }
    ...
    _this.onSectionChange = function (_ref4) {
      ...
      if (pageIsChanged) {
        var _getRouteById = Object(_routes_utils__WEBPACK_IMPORTED_MODULE_12__["getRouteById"])(pageId, routes),
            _sections = _getRouteById.sections;

        var _index = _sections.findIndex(function (item) {
          return item.id === id;
        });
...
//# sourceMappingURL=0.584d8f0adf5fa1681997.hot-update.js.map